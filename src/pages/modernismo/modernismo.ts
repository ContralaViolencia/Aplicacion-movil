...
@IonicPage()
@Component({
  selector: 'page-modernismo',
  templateUrl: 'modernismo.html',
})
export class ModernismoPage {
  ...
  mJson = [
    ...
    {
      id:3,
      titulo:'Mundo Evolutivo',
      ruta:'../../assets/img/mundo.jpg',
    ...
    {
      id:4,
      titulo:'Religion y Nosotros',
      ruta:'../../assets/img/religion.jpg',
  ...
  itemTapped(item) {
    this.navCtrl.push(ModernismoDetailPage, {
      item: item
    });
  }
